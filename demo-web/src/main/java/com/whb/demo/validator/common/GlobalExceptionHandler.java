package com.whb.demo.validator.common;
...
//    }
    ...
    public RspDTO<Object> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        logger.error(e.getMessage(), e);
    ...
    public RspDTO<Object> handleValidationException(ValidationException e) {
        logger.error(e.getMessage(), e);
    ...
    public RspDTO<Object> handleConstraintViolationException(ConstraintViolationException e) {
        logger.error(e.getMessage(), e);
        return new RspDTO(PARAM_FAIL_CODE, e.getMessage());
    }

    @ExceptionHandler(NoHandlerFoundException.class)
    public RspDTO<Object> handlerNoFoundException(Exception e) {
        logger.error(e.getMessage(), e);
...
//    }
    ...
    public RspDTO<Object> handleException(Exception e) {
        System.out.println("=================");
        logger.error(e.getMessage(), e);
